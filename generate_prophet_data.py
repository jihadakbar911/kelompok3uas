...
# Logika ini sama persis seperti yang ada di app.py
...
# Konversi ke format dictionary list (yang siap jadi JSON)
data_to_save = hasil_prediksi.to_dict(orient='records')

# Simpan hasilnya ke dalam sebuah file JSON
with open('static/prophet_forecast.json', 'w') as f:
    json.dump(data_to_save, f)

print("\n✅ Berhasil! File 'prophet_forecast.json' telah dibuat di dalam folder 'static'.")